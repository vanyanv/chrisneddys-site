 ...
 *
 * The top bar, tab strip and "Orders" title render immediately — they
 * don't wait on the orders read, so holding them back traded a skeleton
 * flash for a blank-screen one on a slow connection (issue #46 follow-up).
 * The status counts, filter chips and the table itself sit behind
 * `<SkeletonHoldBack>`.
 */
